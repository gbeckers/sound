...
from .snd import Snd
from .sndfile import SndFile, audiofloat_to_PCM_factor, encodingtodtype
...
def sine_PCM(f=441., nframes=441, fs=44100, encoding='PCM_32'):
    ...
    return Snd(frames, samplingrate=snd.samplingrate, usermetadata=snd.usermetadata, encoding=encoding)
...
def noise_DOUBLE(nframes=441, fs=44100, seed=None):
    ...
    return Snd(p, samplingrate=fs, usermetadata={'seed': seed})
